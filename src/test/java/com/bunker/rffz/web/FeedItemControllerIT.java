...
public class FeedItemControllerIT {
	...
	@Test
	public void shouldGetNewestFeedItemListAsXml() {
		// given articles with max creation date
		FeedItemList feedItemsWithMaxCreationDate = feedItemService.getArticlesWithMaxCreationDate();
		String maxCreationDateAsString = feedItemsWithMaxCreationDate.getFeedItems().get(0).getCreationDate();

		String restUrl = REST_ALL_ARTICLES_URL + "/" + maxCreationDateAsString;
		...
		// then
		assertThat(statusCode, is(200));
		assertThat(retrievedFeedItemList, is(feedItemsWithMaxCreationDate));
	}
	@Test
	public void shouldGetNewestFeedItemListAsJson() {
		// given articles with max creation date
		FeedItemList feedItemsWithMaxCreationDate = feedItemService.getArticlesWithMaxCreationDate();
		String maxCreationDateAsString = feedItemsWithMaxCreationDate.getFeedItems().get(0).getCreationDate();
	...
	@Test
	public void shouldGetNewestFeedItemListAsAtom() {
		// given articles with max creation date
		FeedItemList feedItemsWithMaxCreationDate = feedItemService.getArticlesWithMaxCreationDate();
		String maxCreationDateAsString = feedItemsWithMaxCreationDate.getFeedItems().get(0).getCreationDate();
